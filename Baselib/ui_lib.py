...
class UILib:
    ...
    def send_keys(self, locator, msg, timeout=10, need_check=True):
    ...
    def scroll_down(self, movepixels=1000, wait_time=2):
        self.logger.debug(f"scroll_down {movepixels} pixels, wait_time={wait_time}")
